...
describe("DayFitnessTrendModel", () => {
	...
	it("should provide overload training zone (1)", (done: Function) => {
		...
		const tsb = -39;
		const dayFitnessTrendModel: DayFitnessTrendModel = new DayFitnessTrendModel(dayStressModel, 10, 20,14, tsb);
	...
	it("should provide types count (1)", (done: Function) => {
		...
		const dayFitnessTrendModel: DayFitnessTrendModel = new DayFitnessTrendModel(dayStressModel, 10, 20,14, 30);
